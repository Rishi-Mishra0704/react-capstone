...
const incomeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchIncomeStatementData.pending, (state) => ({ ...state, status: 'loading' }))
      .addCase(fetchIncomeStatementData.fulfilled, (state, action) => ({ ...state, status: 'succeeded', data: action.payload }))
      .addCase(fetchIncomeStatementData.rejected, (state, action) => ({ ...state, status: 'failed', error: action.error.message }));
  },
});
